...
class woocommerce_category_banner_management_Public
{
    ...
    public function enqueue_styles_scripts()
    {
        ...
        $banner_data = array();
        if ( function_exists( 'is_product_category' ) && is_product_category() || function_exists( 'is_shop' ) && is_shop() || function_exists( 'is_cart' ) && is_cart() || function_exists( 'is_checkout' ) && is_checkout() ) {
            //enqueue stylesheets.
            wp_enqueue_style(
                $this->plugin_name,
